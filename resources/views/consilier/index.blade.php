<x-layout>
    ...
    <div class="flex justify-between items-center mb-8 gap-4">
        ...
        <a href="/"
           class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-4 rounded-xl text-lg font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex items-center gap-2 border border-gray-500">
            <span>⬅</span>
            Înapoi la Dashboard
        </a>

        <a href="{{ route('vehicles.index') }}"
           class="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-8 py-4 rounded-xl text-lg font-bold uppercase tracking-wider shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex items-center gap-3 border border-blue-400">
            <span class="text-2xl">🚘</span>
            Vezi Stoc Vehicule & Asignează
        </a>
