        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex flex-col md:flex-row justify-between items-end md:items-center gap-4">
                ...
                <form action="{{ route('vehicles.index') }}" method="GET" class="w-full md:w-1/3">
                    {{-- ✅ MODIFICARE IMPORTANTA: Pastram clientul selectat cand cautam --}}
                    ...
                    <div class="relative">
                        ...
                        {{-- Buton Reset --}}
                        @if(request('search'))
                            <a href="{{ route('vehicles.index', ['client_id' => request('client_id')]) }}" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-red-600" title="Șterge filtrarea">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-100 hover:shadow-md transition duration-300 relative border-t-4 border-t-red-700">
                        <div class="p-6 flex flex-col h-full">
                            ...
                            <div class="pt-4 mt-auto border-t border-gray-50">
                                @if($car->client_id)
                                    {{-- STATUS: VEHICUL ASIGNAT --}}
                                    <div class="bg-orange-50 border border-orange-200 p-3 rounded-lg text-center">
                                        <span class="flex items-center justify-center text-xs font-bold text-orange-800 uppercase tracking-widest mb-1">
                                            Vehicul asignat lui
                                        </span>
                                ...
                                @else
                                    ...
                                    <div class="flex flex-col gap-3">
                                        ...
                                        {{-- ✅ BUTON MODIFICAT: Trimite client_id in link --}}
                                        <a href="{{ route('vehicles.sell', ['id' => $car->id, 'client_id' => $client->id ?? null]) }}" class="group w-full flex items-center justify-center bg-red-700 text-white px-4 py-3 rounded-md text-sm uppercase font-bold hover:bg-red-800 transition shadow-sm hover:shadow relative overflow-hidden">
