            ...
            <div class="lg:col-span-3 space-y-6 top-6">
                <div class="bg-white p-6 rounded-xl shadow-lg border-t-8 border-black">
                    ...
                    <div class="space-y-5 pt-6 border-t border-gray-100 text-sm">
                        ...
                        <div class="group">
                            <label class="text-xs text-gray-400 font-bold uppercase mb-1 block">Consilier alocat</label>
                        ...
                        @forelse($client->leads as $lead)
                            <div class="flex gap-6 group">
                                <div class="w-32 text-right pt-4 flex-shrink-0">
                                    <p class="font-black text-gray-900 text-lg leading-none">{{ $lead->appointment_date->translatedformat('d M') }}</p>
                                    <p class="text-xs text-gray-400 font-bold uppercase mt-1">{{ $lead->appointment_date->translatedformat('l') }}</p>
                                ...
                                <div class="flex-grow pb-8">
                                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition hover:border-red-200 relative">
                                        ...
                                        <div class="flex justify-between items-start mb-3">
                                            ...
                                            <div class="text-xs font-bold px-4 py-2 rounded border transition flex items-center gap-2 {{ $lead->is_completed ? 'bg-green-50 text-green-700 border-green-200 hover:bg-green-100' : 'bg-white text-yellow-700 border-yellow-300 hover:bg-yellow-50 shadow-sm' }}">
